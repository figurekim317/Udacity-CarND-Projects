...
int main()
{
    ...
    pid.Init(0.2, 0.001, 4); //final parameters, average cte < 0.02 after one lap.
                    ...
                    if (length && length > 2 && data[0] == '4' && data[1] == '2')
                    {
                        ...
                        if (s != "")
                        {
                            ...
                            if (event == "telemetry")
                            {
                                ...
                                double avg_cte = pid.AverageCTE(cte);

                                // DEBUG
                                //std::cout << "CTE: " << cte << " Steering Value: " << steer_value << std::endl;
                                printf("CTE: %6.4f Steering Value: %.4f AvgCTE: %6.4f\n", cte, steer_value, avg_cte);
